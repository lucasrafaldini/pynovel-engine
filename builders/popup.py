...
class PopupBuilder:
    def init_popup(screen: pygame.Surface, mode: str='save_success') -> Dict[str, Any]:
        popup_settings: Dict[str, Dict[str, Any]] = config.popup_settings
        
        font = pygame.font.Font(None, popup_settings[mode]['font_size'])
        text_surf = font.render(popup_settings[mode]['message'], True, popup_settings[mode]['text_color'])
